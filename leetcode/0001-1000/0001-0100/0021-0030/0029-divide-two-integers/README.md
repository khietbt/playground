...
Given two integers `dividend` and `divisor`, divide two integer **without**
using multiplication, division, and mod operators.
...
return `2$^31$ -1`, and if the quotient is **strictly less than** `-2$^31$`,
then return `-2$^31`.
