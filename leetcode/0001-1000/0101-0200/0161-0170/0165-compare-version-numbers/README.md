...
version string consists of **revisions** separated by dots `'.'`. The **value of
...
> **Output:** 0
>
> **Explanation:** Ignoring leading zeros, both "01" and "001" represent the
> same integer "1".
...
> **Output:** 0
>
> **Explanation:** version 1 has less revisions, which means every missing
...
- All the given revisions `version1` and `version2` can be stored in a **32-bit
  integer**.
