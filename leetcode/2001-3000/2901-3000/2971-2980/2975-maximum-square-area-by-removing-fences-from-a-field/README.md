...
**removing** some fences (**possibly none**) or `-1` if it is possible to make
a square field_.
...
coordinates `(1, 1)` to `(m, 1)` and `(1, n)` to `(m, n)`. These fences
**cannot** be removed.
...
> **Output:** 4
>
> **Explanation:** Removing the horizontal fence at 2 and the vertical fence at
> 2 will give a square field of area 4.
