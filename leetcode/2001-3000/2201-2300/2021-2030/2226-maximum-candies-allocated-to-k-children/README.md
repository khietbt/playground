...
You are given a **0-indexed** array `candies`. Each element in the array denotes
...
> **Output:** 5
>
> **Explanation:** We can divide `candies[1]` into 2 piles of 5 & 3, and
> `candies[2]` into 2 piles of 5 & 1. We now have five piles of candies of sizes
> 5, 5, 3, 5 & 1. We can allocate the 3 piles of size 5 to 3 children. It can be
