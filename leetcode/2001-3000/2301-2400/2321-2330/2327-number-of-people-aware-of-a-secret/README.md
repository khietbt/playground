...
discovering the secret. You are also given an integer `forget`, which means that
each person will **forget** the secret `forget` days after discovering it. A
...
> - Day 3: A and B share the secret with 2 new people, C & D. (4 people)
