...
Given an array `nums`, you can perform the following operation any number times:
...
> **Explanation:**
>
> - The pair `(3, 1)` has the minimum sum of 4. After replacement,
>   `nums = [5, 2, 4]`.
> - The pair `(2, 4)` has the minimum sum of 6. After replacement,
>   `nums = [5, 6]`.
>
