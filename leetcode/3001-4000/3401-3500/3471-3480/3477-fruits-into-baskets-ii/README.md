...
You are given two array of integers, `fruits` and `baskets`, each of length `n`,
...
- Each fruit types must be placed in the **leftmost available basket** with a
...
> - `fruits[2] = 5` is placed in `baskets[2] = 4`.
>
