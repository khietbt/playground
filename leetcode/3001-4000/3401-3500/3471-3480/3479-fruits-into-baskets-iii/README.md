...
`n`, where `fruites[i]` represents the **quantity** of the `i$^th$` type of
fruit, and `baskets[j]` represents the **capacity** of the `j$^th$` basket.
...
> - `fruits[1] = 6` cannot placed in `baskets[1] = 4` (insufficient capacity)
