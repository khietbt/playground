...
The integer `x` and `y` represent the row and column indices of the **top-left**
...
> - `k = 3`
>
> **Output:** `[[1, 2, 3, 4], [13, 14, 15, 16], [9, 10, 11, 12], [5, 6, 7, 16]]`
>
> **Explanation:** The diagram above shows the grid before and after the
> transformation.
