...
the top-left cell `(0, 0)` and your goal is o reach the bottom-right cell
`(m -1, n -1)`.

There are two types of moves available:

- **Normal move:** You can move right or down from your current cell `(i, j)`,
  i.e. you can move from `(i, j + 1)` (right) or `(i + 1, j)` (down). The cost is
...
> **Explanation:**
>
> Initially, we start at (0, 0) and cost is 0.
>
