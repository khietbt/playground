...
Return the **maximum** possible profit you can archive.

**Note:** There are no constraints on budget or stock ownership, so all buy
and sell operations are feasible regardless past actions.
...
> | ----------------- | ------------ | --------------------------------------------- | -----: |
> | Original          | `[-1, 0, 1]` | (-1 x 4) + (0 x 2) + (1 x 8) = -4 + 0 + 8 = 4 |      4 |
> | Modify `[0, 1]`   | `[0, 1, 1]`  | (0 x 4) + (1 x 2) + (1 x 8) = 0 + 2 + 8 = 10  |     10 |
> | Original `[1, 2]` | `[-1, 0, 1]` | (-1 x 4) + (0 x 2) + (1 x 8) = -4 + 0 + 8 = 4 |      4 |
>
