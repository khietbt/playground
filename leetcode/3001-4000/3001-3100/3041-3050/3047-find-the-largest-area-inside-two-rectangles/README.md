...
**bottom-left** and **top-right** coordinates of the `i$^th$` rectangle,
respectively.

You need to find the **maximum** area of a **square**that can fit inside in the
...
> intersecting region of rectangles 0 & 1 or the intersecting region of
> rectangles 1 & 2. Hence the maximum area is 1. It can be shown that a square
> with a greater length cannot fit inside any intersecting region or two
> rectangles.
...
> intersecting region of rectangles 0 & 1 or the intersecting region of
> rectangles 1 & 2. Hence the maximum area is 2 \* 2 = 4. It can be shown that a
> square with a greater side length cannot fit inside any intersecting region of
> two rectangles.
...
> region of two rectangles. Also, no larger square can, so the maximum area is 1.
