...
Given an integer `n`, return _a list of two integers `[a, b]` where_:
...
>
> Both a & b are no-zero integers, and a + b = 11 = n.
>
> Not that there are other valid answers as `[8, 3]` that can be accepted.
