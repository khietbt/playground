...
Return _the **minimum** number of **type-2** operations you need to perform such
that `s` becomes **alternating**_.

The string is called **alternating** if no two adjacent characters are equal.

- For example, the strings `"0101"` and `"1010"` are alternating, while the
  string `"0100"` is not.
...
> use the second operation on the third and sixth elements to make s = "101010".
